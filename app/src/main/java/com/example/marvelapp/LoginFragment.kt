...
class LoginFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.login.setOnClickListener{
            if (binding.emailrgstrlog1.text!!.isEmpty()){
                ...
                if (binding.passwordrgstrlog1.text!!.isEmpty()){
                    ...
                    if (a==1){
                        findNavController().navigate(R.id.action_loginFragment2_to_menuHomeFragment)
                    }else{
                        Toast.makeText(
                            requireContext(),
        ...
        binding.alredyhaveacc1.setOnClickListener{
            findNavController().navigate(R.id.action_loginFragment2_to_createFragment)
        }
