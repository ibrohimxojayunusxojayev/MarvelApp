...
import com.example.marvelapp.databinding.FragmentBankBinding
...
class BankFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.contpay.setOnClickListener{
            findNavController().navigate(R.id.action_bankFragment_to_cardFragment)
        }
        binding.credit.setOnClickListener{
            findNavController().navigate(R.id.action_bankFragment_to_cardFragment)
        }
        binding.netbank.setOnClickListener{
            findNavController().navigate(R.id.action_bankFragment_to_cardFragment)
        }
